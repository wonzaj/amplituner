...
uint16_t _buffer_height = DISPLAY_HEIGHT;    //buffer dimensions used to determine if pixel is within array bounds
uint16_t _buffer_width = DISPLAY_WIDTH;      //by default buffer size is equal to OLED size
