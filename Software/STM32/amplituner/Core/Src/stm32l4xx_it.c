...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENC_TREBLE_1_Pin);
...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENC_TREBLE_2_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENCODER_RADIO_2_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Relay_dac_mic_Pin);
